<%@ Page Title="Create New Course" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateCourse.aspx.cs" Inherits="CreateCourse" %>
        ...
        <div class="col-12">
            <asp:Table runat="server">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:TextBox TextMode="Number" runat="server" ID="CourseRatingTB"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
                    ...
                    <asp:TableCell>
                        <asp:TextBox TextMode="Number" runat="server" ID="SlopeRatingTB"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
